...
CREATE DATABASE IF NOT EXISTS ncs_sim_ods COMMENT 'NCS充电桩项目-原始数据层ODS';
CREATE DATABASE IF NOT EXISTS ncs_sim_dwd COMMENT 'NCS充电桩项目-明细数据层DWD';
CREATE DATABASE IF NOT EXISTS ncs_sim_dws COMMENT 'NCS充电桩项目-聚合数据层DWS';
CREATE DATABASE IF NOT EXISTS ncs_sim_ads COMMENT 'NCS充电桩项目-应用数据层ADS';
...
-- =============================================================================
DROP TABLE IF EXISTS ncs_sim_ods.ods_charging_process;
CREATE EXTERNAL TABLE IF NOT EXISTS ncs_sim_ods.ods_charging_process (
...
STORED AS TEXTFILE
LOCATION '/ncs/sim_ods/ods_charging_process'
...
-- =============================================================================
DROP TABLE IF EXISTS ncs_sim_ods.ods_charging_order;
CREATE EXTERNAL TABLE IF NOT EXISTS ncs_sim_ods.ods_charging_order (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/ncs/sim_ods/ods_charging_order'
...
-- =============================================================================
DROP TABLE IF EXISTS ncs_sim_ods.ods_charging_station_meta;
CREATE EXTERNAL TABLE IF NOT EXISTS ncs_sim_ods.ods_charging_station_meta (
    stationId      STRING  COMMENT '充电站唯一标识ID',
    locationId     STRING  COMMENT '位置区域ID',
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
STORED AS TEXTFILE
LOCATION '/ncs/sim_ods/ods_charging_station_meta'
TBLPROPERTIES ('skip.header.line.count'='1');
...
USE ncs_sim_ods;  --切换数据库
SHOW TABLES;  --显示有那些表
DESC FORMATTED ncs_sim_ods.ods_charging_order;
