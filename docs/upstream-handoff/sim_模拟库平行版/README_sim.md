...
## 一、生成模拟 CSV（Windows 上）

```cmd
cd /d D:\Lin\交付_ODS_DWD
python gen_sim_data.py --orders 5000 --out D:\simdata
:: 生成 nvv2t.csv / dsv13r2.csv / nvv2t_md_end.csv 到 D:\simdata
```
...
scp D:\simdata\dsv13r2.csv hadoop@192.168.176.100:/home/hadoop/simdata/
scp D:\simdata\nvv2t_md_end.csv hadoop@192.168.176.100:/home/hadoop/simdata/
scp D:\Lin\交付_ODS_DWD\sim_scripts\*.hql hadoop@192.168.176.100:/home/hadoop/
scp D:\Lin\交付_ODS_DWD\sim_scripts\06_sim_export.sh hadoop@192.168.176.100:/home/hadoop/
```
