...
FROM ncs_ods.ods_charging_order;
...
FROM ncs_ods.ods_charging_process p
LEFT JOIN ncs_dwd.dwd_charging_order o ON p.esd = o.session_id;
...
SELECT
  ...
  open_time,
  update_time
FROM ncs_ods.ods_charging_station_meta;
